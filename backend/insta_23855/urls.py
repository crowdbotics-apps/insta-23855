...
admin.site.site_header = "Insta"
admin.site.site_title = "Insta Admin Portal"
admin.site.index_title = "Insta Admin"

# swagger
api_info = openapi.Info(
    title="Insta API",
    default_version="v1",
    description="API documentation for Insta App",
)
